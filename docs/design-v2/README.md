...
Первоначальный набор из десяти макетов. Актуальные снимки компактного приложения, включая изображения в чате, — в [design-qa.md](design-qa.md). [Концепция и процесс](CONCEPT.md) · [Визуальное задание](PROMPTS.md) · [Архитектура приложения](../ARCHITECTURE.md).
